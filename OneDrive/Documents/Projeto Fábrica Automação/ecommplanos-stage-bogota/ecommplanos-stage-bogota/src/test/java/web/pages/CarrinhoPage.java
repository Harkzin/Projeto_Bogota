...
public class CarrinhoPage {
    ...
    private void validarCamposPortabilidade() {
        ...
        driverWeb.waitElementVisible(cpfPortabilidade, 1);
...
//        try {
//            WebDriverWait wait = new WebDriverWait(driverWeb.getDriver(), Duration.ofSeconds(10));
//
//
//            // Localizando os elementos com espera explícita
//            telefonePortabilidade = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("txt-telefone-portabilidade")));
//            cpfPortabilidade = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("txt-cpf-portabilidade")));
//
//            // Rolando para os elementos, se necessário
//            if (telefonePortabilidade != null) {
//                JavascriptExecutor js = (JavascriptExecutor) driverWeb.getDriver();
//                js.executeScript("arguments[0].scrollIntoView(true);", telefonePortabilidade);
//            }
//
//            // Validações
//            assertTrue(cpfPortabilidade.isDisplayed());
...
//            System.err.println("Elemento não encontrado no tempo esperado: " + e.getMessage());
//        } catch (Exception e) {
//            System.err.println("Erro ao validar os campos de portabilidade: " + e.getMessage());
//            throw e;
//        }
    }
    ...
    public String inserirDadosPortabilidadePix(String telefone) {
        String cpf = getCpfForPixFlow();
        driverWeb.sendKeys(telefonePortabilidade, telefone);
    ...
    public String inserirDadosAquisicaoPix(String telefone) {
        String cpf = getCpfForPixFlow();
