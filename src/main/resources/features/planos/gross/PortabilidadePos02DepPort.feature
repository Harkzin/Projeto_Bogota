#language: pt
@Regressivo
Funcionalidade: Aquisição Pos - 02 Dependente

  @Portabilidade
  @Pos
  @PortabilidadePos02DepPort
  Cenario: Aquisição Pos - 02 Dependente
    ...
    Então é direcionado para a tela de Dados Pessoais
      Mas não deve haver alterações no valor e nem nas informações do Plano
    E preenche os campos de dados pessoais: [Nome Completo] "ECOMMAUT PORTPOS DEP", [Data de Nascimento] "01011991" e [Nome da Mãe] "NOME MAE"
