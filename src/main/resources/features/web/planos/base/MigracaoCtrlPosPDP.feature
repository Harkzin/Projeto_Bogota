...
Funcionalidade: ECCMAUT-258 - Migracao Controle para Pos - PDP
  ...
  Cenario: Migracao Controle para Pos - PDP
    ...
    E preenche os campos: [Telefone com DDD] "Controle" "Boleto" "E-mail" comboMulti "false", [E-mail] e [CPF] multaServico "false" multaAparelho "false" dependente "false" claroClube "false" crivo "na"
