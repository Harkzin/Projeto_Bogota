...
@Regressivo
@Web
Funcionalidade: ECCMAUT-1176 - Jornadas cruzadas - Titular portabilidade, 1 dependente aquisição, 1 dependente portabilidade

  @Portabilidade
  @Pos
  @JornCruzTituPort01DepAqui01DepPort
  Cenario: Jornadas cruzadas - Titular portabilidade, 1 dependente aquisição, 1 dependente portabilidade
    ...
    E preenche os campos de endereço: [CEP] convencional "04709110", [Número] "65" e [Complemento] "AP202"
