...
Funcionalidade: ECCMAUT-510 - Portabilidade Pos com numero Base
  ...
  Cenario: Portabilidade - Numero Base
    ...
    E preenche os campos: [Telefone a ser portado com DDD] "Pos" "Boleto" "Correios" comboMulti "false", [E-mail] e [CPF] multaServico "false" multaAparelho "false" dependente "false" claroClube "false" crivo "na"
