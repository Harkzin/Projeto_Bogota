...
#      Mas não deve haver alterações no valor e nem nas informações do Plano
    ...
    * update-order-sap [ecommerceOrderId "teste"] [status "Aguardando Impressão NF"]
    * update-order-sap [ecommerceOrderId "teste"] [status "Aguardando Conf. de Entrega 1"]
    * update-order-sap [ecommerceOrderId "teste"] [status "Finalizada"]
    * update-order [ecommerceOrderId "teste"], [sapOrderId "teste"]
