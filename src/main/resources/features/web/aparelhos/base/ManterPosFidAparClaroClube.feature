...
@Web
Funcionalidade: ECCMAUT-195 - Manter o Plano com Fidelidade e Aparelho - Cartao + Claro Clube

  #Massa: POS com pontos de Claro Clube

  @Aparelho
  @Pos
  @ManterPosFidAparClaroClube
  Cenario: Manter o Plano com Fidelidade e Aparelho - Cartao + Claro Clube
    ...
    E preenche o campo [Seu numero Claro] com "11947891930"
