...
Funcionalidade: ECCMAUT-196 - Carrinho com produtos diferentes
  ...
  Cenario: Carrinho com produtos diferentes
    ...
    Quando o usuário clicar no botão [Comprar] no produto [ACESSÓRIO] "000000000000062125"
    Então é direcionado para a PDP do Acessório selecionado
    E o usuário clicar no botão [Comprar] na PDP de Acessórios [ACESSÓRIO] "000000000000062125"
    ...
    Quando o usuário clicar no botão [Comprar] no produto [ACESSÓRIO] "000000000000062124"
    Então é direcionado para a PDP do Acessório selecionado

    E o usuário clicar no botão [Comprar] na PDP de Acessórios [ACESSÓRIO] "000000000000062124"
    Entao é direcionado para a tela de Carrinho de Acessórios
