...
public class HomeSteps extends BaseSteps {
    ...
    @E("selecionar o {string} plano do carrossel da Home clicando no botão Eu quero! dele")
    public void selecionarOPlanoDoCarrosselDaHome(String cardHome) throws Throwable {
