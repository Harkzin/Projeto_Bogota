...
Funcionalidade: ECCMAUT-228 - Troca Controle recusa multa
  ...
  Cenario: Troca Controle recusa multa
    ...
    E preenche os campos: [Telefone com DDD] "Controle" "Debito" "E-mail" comboMulti "false", [E-mail] e [CPF] multaServico "true" multaAparelho "false" claroClube "false" crivo "na"
